# READ FIRST — Agentic AI Instructions (BlackRavenia UrwayDispatch)

**Timestamp (America/Chicago): 2026-02-04 05:21:23**

## 1) The ONLY requirements authority
- `BlackRavenia_UrwayDispatch_Canonical_Requirements_v6_1.md` is the ONLY requirements authority.
...
4. `BlackRavenia_UrwayDispatch_Canonical_Requirements_v6_1.md` (build requirements)
