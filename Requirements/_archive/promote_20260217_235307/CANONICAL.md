...
<!-- Source: CANONICAL_v6_1_MERGED_REORG_v3.md -->
<!-- SourcePath: C:\Users\Detaimfc\Downloads\UrwayDispatch\Requirements\CANONICAL_v6_1_MERGED_REORG_v3.md -->
<!-- Note: Source file preserved; CANONICAL.md is the stable scan target for EBT (Enterprise Build Template). -->

# Rideoo-UrwayDispatch Platform — Canonical Requirements (v6.1)
...
# UrwayDispatch Addendum: Multi-Tenant (Tenant-First) Architecture + Capabilities

## Purpose
UrwayDispatch is a SaaS (Software as a Service) multi-tenant platform where **tenants** launch and operate their **own Uber-like / limo-style dispatch business**, with full capability parity (within their tenant) as if UrwayDispatch launched a single-tenant consumer marketplace.
...
# UrwayDispatch Addendum: Tenant-First Decisions (Apps + Payments + Settlement + Service Area + Compliance + Retention)
