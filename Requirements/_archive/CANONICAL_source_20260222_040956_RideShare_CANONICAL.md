# Rideoo UrwayDispatch Platform — Canonical Requirements (v10.1)

**Timestamp (America/Chicago): 2026-02-22 02:22**  

**Repo:** `PaySurity-Biz/UrwayDispatch` (https://github.com/PaySurity-Biz/UrwayDispatch)
**Canonical location in repo:** `Requirements/CANONICAL.md` (stable EBT/agentic scan target; do not use legacy BlackRavenia/_archive files)
...
**Scope:** Passenger rides first. Multi-tenant, white-label SaaS. **Rideoo is the software provider; tenants are the service providers** (ops/compliance/insurance are tenant responsibilities). **Rideoo does not operate rides; tenants do.**  
...
**Merged sources (semantic):** `UrwayDispatch-chat1-requirements.txt` + `UrwayDispatch context.txt`  
...
| SAFE-TK-0001 | Safety Toolkit (premium add-on; tenant opt-in; configurable fee) | platform | DOD-UI;DOD-API;DOD-DB;DOD-TEST;DOD-AUDIT;DOD-OPS |
| BILL-ADD-0001 | Premium add-on billing (e.g., Safety Toolkit) via fee catalog + autopull gating | platform | DOD-MONEY;DOD-API;DOD-TEST;DOD-AUDIT |
| CORP-EXP-0001 | Corporate travel & expensing exports (tenant opt-in; export-first) | tenant | DOD-UI;DOD-API;DOD-TEST;DOD-AUDIT |
...
{"req_id": "TEN-BASE-0001", "title": "Tenant provisioning + isolation", "scope": "platform", "dod": ["DOD-API", "DOD-DB", "DOD-TEST", "DOD-AUDIT"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "TEN-BASE-0002", "title": "Tenant RBAC + roles", "scope": "platform", "dod": ["DOD-UI", "DOD-API", "DOD-TEST", "DOD-AUDIT"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "CFG-TEN-0001", "title": "Tenant config schema + versioning", "scope": "tenant", "dod": ["DOD-UI", "DOD-API", "DOD-TEST", "DOD-AUDIT"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "CFG-PLAT-0001", "title": "Platform config schema + versioning", "scope": "platform", "dod": ["DOD-UI", "DOD-API", "DOD-TEST", "DOD-AUDIT"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "TEN-POL-0001", "title": "Policy Center enable-only", "scope": "tenant", "dod": ["DOD-UI", "DOD-API", "DOD-TEST", "DOD-AUDIT"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "TEN-POL-0002", "title": "Templates disclaimer + ack + audit", "scope": "tenant", "dod": ["DOD-UI", "DOD-API", "DOD-TEST", "DOD-AUDIT"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "MIC-WGT-0001", "title": "Tenant microsite booking + quote widget", "scope": "tenant", "dod": ["DOD-UI", "DOD-API", "DOD-TEST"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "MIC-PUB-0001", "title": "Static-first microsite publish + CDN", "scope": "platform", "dod": ["DOD-INFRA", "DOD-OPS", "DOD-TEST"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "RID-WEB-0001", "title": "Rider web booking flow (tenant-scoped)", "scope": "rider", "dod": ["DOD-UI", "DOD-API", "DOD-TEST"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "RID-MOB-0001", "title": "Rider mobile booking flow (tenant-scoped)", "scope": "rider", "dod": ["DOD-UI", "DOD-API", "DOD-TEST"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "DRV-WEB-0001", "title": "Driver web core flows (tenant-scoped)", "scope": "driver", "dod": ["DOD-UI", "DOD-API", "DOD-TEST"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "DRV-MOB-0001", "title": "Driver mobile core flows (tenant-scoped)", "scope": "driver", "dod": ["DOD-UI", "DOD-API", "DOD-TEST"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "DIS-REAL-0001", "title": "WS realtime primary + SSE/poll fallback", "scope": "platform", "dod": ["DOD-REALTIME", "DOD-OPS", "DOD-TEST"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "DIS-OFR-0001", "title": "Offer lifecycle state machine", "scope": "tenant", "dod": ["DOD-API", "DOD-DB", "DOD-TEST", "DOD-AUDIT"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "TRP-STM-0001", "title": "Trip state machine + transitions", "scope": "tenant", "dod": ["DOD-API", "DOD-DB", "DOD-TEST", "DOD-AUDIT"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "PAY-FLOW-0100", "title": "Tenant-wide funds routing when platform-paid payouts enabled", "scope": "tenant", "dod": ["DOD-MONEY", "DOD-API", "DOD-DB", "DOD-TEST", "DOD-AUDIT"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "PAY-SETL-0001", "title": "Payout gating by bank_settled when platform-paid", "scope": "tenant", "dod": ["DOD-MONEY", "DOD-API", "DOD-TEST", "DOD-AUDIT"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "PAY-ADJ-0001", "title": "Adjustments + clawbacks + recovery", "scope": "tenant", "dod": ["DOD-MONEY", "DOD-API", "DOD-DB", "DOD-TEST", "DOD-AUDIT"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "BILL-INV-0001", "title": "Invoices + pricing plans + fees (platform-controlled)", "scope": "platform", "dod": ["DOD-MONEY", "DOD-UI", "DOD-API", "DOD-TEST", "DOD-AUDIT"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "BILL-AUTO-0001", "title": "Billing autopull (as-needed + scheduled) + dunning", "scope": "platform", "dod": ["DOD-MONEY", "DOD-API", "DOD-JOBS", "DOD-TEST", "DOD-OPS"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "SAFE-TK-0001", "title": "Safety Toolkit (premium add-on; tenant opt-in; configurable fee)", "scope": "platform", "dod": ["DOD-UI", "DOD-API", "DOD-DB", "DOD-TEST", "DOD-AUDIT", "DOD-OPS"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "BILL-ADD-0001", "title": "Premium add-on billing (e.g., Safety Toolkit) via fee catalog + autopull gating", "scope": "platform", "dod": ["DOD-MONEY", "DOD-API", "DOD-TEST", "DOD-AUDIT"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "CORP-EXP-0001", "title": "Corporate travel & expensing exports (tenant opt-in; export-first)", "scope": "tenant", "dod": ["DOD-UI", "DOD-API", "DOD-TEST", "DOD-AUDIT"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "JOB-QUE-0001", "title": "DB-backed job queue + DLQ + replay tooling", "scope": "platform", "dod": ["DOD-JOBS", "DOD-OPS", "DOD-TEST"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "NOT-PUSH-0001", "title": "Push notifications interface + FCM provider", "scope": "platform", "dod": ["DOD-OPS", "DOD-TEST"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "DOC-STO-0001", "title": "Object storage for uploads + retention", "scope": "platform", "dod": ["DOD-API", "DOD-OPS", "DOD-TEST"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "AUD-EVT-0001", "title": "Audit event taxonomy (money + state changes)", "scope": "platform", "dod": ["DOD-AUDIT", "DOD-API", "DOD-DB", "DOD-TEST"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "OBS-DASH-0001", "title": "Ops dashboards (realtime, dispatch, payments, jobs)", "scope": "platform", "dod": ["DOD-OPS", "DOD-TEST"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "TAX-1099-0001", "title": "Driver earnings summary + export 1099 layout", "scope": "tenant", "dod": ["DOD-MONEY", "DOD-UI", "DOD-API", "DOD-TEST", "DOD-AUDIT"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "UI-FAQ-0001", "title": "Public FAQs page + bot training dataset", "scope": "platform", "dod": ["DOD-UI", "DOD-TEST"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "API-IDEM-0001", "title": "Idempotency keys for all writes", "scope": "platform", "dod": ["DOD-API", "DOD-DB", "DOD-TEST"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "API-ERR-0001", "title": "Standard error codes + version conflicts", "scope": "platform", "dod": ["DOD-API", "DOD-TEST"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "MAP-GEO-0001", "title": "Geo calc + rounding + units", "scope": "platform", "dod": ["DOD-API", "DOD-TEST"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "TIME-TZ-0001", "title": "Timezone rules (UTC storage; tenant-local display)", "scope": "platform", "dod": ["DOD-API", "DOD-TEST"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "GCP-ARCH-0001", "title": "GCP hosting baseline (Cloud Run + Cloud SQL + GCS + CDN)", "scope": "platform", "dod": ["DOD-INFRA", "DOD-OPS"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "GCP-ARCH-0002", "title": "Tenant microsite domains + TLS + canonical behavior", "scope": "platform", "dod": ["DOD-INFRA", "DOD-OPS", "DOD-TEST"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
{"req_id": "DRV-MULT-0001", "title": "Driver can accept multiple trips; no platform overlap enforcement", "scope": "driver", "dod": ["DOD-API", "DOD-DB", "DOD-TEST", "DOD-AUDIT"], "status_taxonomy": ["NOT_STARTED", "IN_PROGRESS", "IMPLEMENTED", "TESTED", "BLOCKED"], "authority": "Requirements/CANONICAL.md"}
...
### 1.2A Ambiguity resolution defaults (authoritative)
These defaults eliminate common “interpretation drift”. Tenants can override only where explicitly allowed (and only within platform caps).

- **Time:** store all timestamps in UTC; display in tenant-local timezone configured in `tenant_config.timezone` (default: `America/Chicago`). (**TIME-TZ-0001**)
- **Location updates (driver → platform):** during active trip states, driver location should be ingested at **≤ 5s** cadence (mobile) and **≤ 15s** cadence (web/PWA). Rider UI refresh targets: **≤ 5s** while in-trip, **≤ 10s** while enroute-to-pickup. Fallback (SSE/poll) may be slower but must not exceed **30s**. (**DIS-REAL-0001**)

- **Offer timings:** defaults unless tenant overrides:
  - `dispatch_policies.offer_ring_sec` = **5**
  - `dispatch_policies.offer_expire_sec` = **15**
  - `dispatch_policies.retry_strategy` = **"auto_hop_then_grabboard"** (implementation must document exact behavior)

- **Arrival detection:** always allow a manual “Arrived” action. If automated arrival is enabled by tenant policy, default geo-radius is **50ft** with a **60s** stationary confirmation; if GPS is unreliable, allow an alternate radius up to **200ft** with explicit driver confirmation. Wait timers start only after “Arrived” is recorded (manual or automated). (**5.3 / 4.4 / TEN-POL**)
- **Messaging retention:** default **180 days**, configurable per tenant **30–365 days** within platform caps; legal-hold preserves redacted metadata beyond retention where required. (**3.4**)
- **Bank-settled truth:** when platform-triggered payouts are enabled, treat any ride as **not eligible** until PaySurity settlement truth marks it `bank_settled` (or stricter). Missing/unknown settlement = pending (safe default). (**PAY-SETL-0001 / RIDE-PAYOUT-101**)
- **Driver multi-trip concurrency:** by default Rideoo does **not** enforce overlap limits (tenant decides). If a tenant enables concurrency limits, enforce only that tenant’s policy. (**DRV-MULT-0001 / TEN-POL dispatch_policies.driver_concurrency**)
...
- Messages retained for **180 days by default**, configurable per tenant within platform caps (**30–365 days**), with legal-hold support where required.
...
### 3.11 Safety Toolkit (premium add-on; tenant opt-in; fee configurable by platform Super Admin)
**Positioning:** Rideoo provides a safety toolkit as a paid module that tenants can choose to enable inside their tenant boundary. Tenants remain the service provider and handle local operational/compliance obligations; Rideoo provides tooling, logs, and evidence.

**Feature set (minimum):**
- **In-app Safety Toolkit entry point** (rider + driver): Emergency assistance button, share-trip link, incident report.
- **Audio recording option (opt-in):** allow rider and/or driver to enable audio recording via the Safety Toolkit.
  - Recordings must be encrypted and stored with a short retention default (e.g., **7 days**) configurable within platform caps.
  - Access is restricted to authorized tenant safety staff and/or platform safety staff (RBAC + audit). Recordings are attached to a safety report for access.
- **Incident reporting workflow:** structured incident types (safety, harassment, accident, medical, lost item), attachments, timeline, and audit trail.
- **Disclosure + consent:** explicit consent UI where required; clear disclosure that recording may be active.

**Billing rule (pinned):**
- Safety Toolkit is a **paid add-on** with a **fee configurable by platform Super Admin / designated platform staff**.
- Fee can be modeled as: per-tenant monthly add-on and/or per-trip safety fee; both must be visible to the tenant in the billing UI. (**BILL-ADD-0001**)

**Implementation safety:** do not block core booking/dispatch if Safety Toolkit is disabled; all safety events must still be logged as audit events when enabled.
...
- Assigned driver + vehicle details shown: driver first name + last initial, driver photo, driver rating (rolling), vehicle make/model/color, license plate, and trip ID. (No rider phone/email exposed.)
...
- Driver sees rider details , not the passenger contact info and vice versa. rider first name + last initial, pickup pin, pickup notes, passenger count, luggage count.
...
- UrwayDispatch calls PaySurity for tokenization, authorization, capture, refund, void.
- PaySurity routes to Fluidpay or Argyle Payments (black box).
- Payment security and compliance:
  - PaySurity must enforce **Payment Card Industry Data Security Standard (PCI DSS)** scope minimization: UrwayDispatch never stores Primary Account Number (PAN) or full card data.
...
**Export-first (tenant responsibility):**
- Default implementation is **export + receipts forwarding** (PDF/CSV). Tenants choose whether to integrate with expense systems (e.g., Concur) or operate export-only.
- Any third-party expense integration is **tenant-owned configuration** and must be feature-gated. Rideoo ships adapters only as optional plugins; failures must not impact booking/dispatch.
...
- Source B (merged): `UrwayDispatch-chat1-requirements.txt`
- Source C (merged context): `UrwayDispatch context.txt`
