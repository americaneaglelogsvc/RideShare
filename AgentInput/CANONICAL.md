# Rideoo-UrwayDispatch Platform â€” Canonical Requirements (v6.1, rev v10)

**Timestamp (America/Chicago): 2026-02-17 21:45**  

**Repo:** `PaySurity-Biz/UrwayDispatch` (https://github.com/PaySurity-Biz/UrwayDispatch)
**Canonical location in repo:** `Requirements/Rideoo_UrwayDispatch_Canonical_Requirements.md` (copy also at repo root for tooling)
